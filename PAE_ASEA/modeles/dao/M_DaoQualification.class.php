...
/**
 * Description of M_DaoQualification
 *
 * @author arichard
 */
class M_DaoQualification extends M_DaoGenerique {

    function __construct() {
        $this->nomTable = "qualification";
        $this->nomClefPrimaire = "idQualification";
    }
    ...
    public function insert($objetMetier) {
        ...
        try {
            ...
            $sql = "INSERT INTO $this->nomTable (libelleQualification) VALUES (:libelleQualification)";
            //var_dump($sql);
    ...
    public function update($idMetier, $objetMetier) {
        ...
        try {
            ...
            $sql .= "libelleQualification = :libelleQualification ";
            $sql .= "WHERE idQualification = :id";
            //var_dump($sql);
            // préparer la requête PDO
            $queryPrepare = $this->pdo->prepare($sql);
    ...
    public function getOneByName($nom) {
        ...
        try {
            //requete
            $sql = "SELECT * FROM $this->nomTable WHERE libelleQualification = :nom";
            //préparer la requête PDO
            $queryPrepare = $this->pdo->prepare($sql);
